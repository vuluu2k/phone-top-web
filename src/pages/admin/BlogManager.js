...
import { Input, Row, Col, Card, Upload, Button, message as messageAntd, Image } from 'antd';
    ...
    <div className="blog-manager">
      <Admin title="Quản lí tin tức">
        <TableCustom title="Đăng tin tức mới">
          ...
          <Button onClick={() => onSumbitCreate()} type="primary" style={{ marginBottom: 16 }}>
              ...
              blogs.map((item, idx) => (
                <Col sm={{ span: 24 }} lg={{ span: 12 }} xl={{ span: 8 }} key={idx}>
                  <Card
                    ...
                    actions={[<EditOutlined key="edit" onClick={() => onEdit(item)} />, <DeleteOutlined key="delete" />]}>
                    <div className="d-flex">
                      <div>
